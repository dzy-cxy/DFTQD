...
def compare_state_dict(loaded_weights, modified_weights):
    for name, param in modified_weights.items():
        if name in loaded_weights:
            print(f"Parameter '{name}' is present in the loaded weights")
        else:
            print(f"Parameter '{name}' is not present in the loaded weights and has been randomly initialized.")
...
def resume_cali_model(qnn, ckpt_path, cali_data, quant_act=False, act_quant_mode='qdiff', cond=False):
    ...
    for name, param in ckpt.items():
        print(f"Parameter '{name}' is in the loaded weights")
    ...
    compare_state_dict(ckpt, qnn.state_dict())
